...
export default class Settings extends Component {
    constructor(props) {
        ...
        this.messages = Language.getDataByKey("novi-plugin-camera-slider");
    }
    ...
    render() {
        return (
            <div>
                <span style={{letterSpacing: "0,0462em"}}>Camera Slider Plugin</span>
    ...
    saveSettings(){
        novi.plugins.settings.update("novi-plugin-camera-slider", this.state.settings);
    }
}